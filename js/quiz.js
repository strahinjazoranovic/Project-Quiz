//Hier wordt duidelijk gemaakt bij welke knopid welke functie erbij hoort
...
// Hier wordt de functie geschreven wanneer je bijvoorbeeld playboicarti button klikt
function playboiQuiz() {
  // Dit is een array met vragen 
  const questions = [
    {
